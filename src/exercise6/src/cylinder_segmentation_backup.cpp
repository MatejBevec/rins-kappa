...
cloud_cb (const pcl::PCLPointCloud2ConstPtr& cloud_blob)
{
  ...
  */
  ...
  seg.setDistanceThreshold (0.020); //0.05 0.015
  seg.setRadiusLimits (0.10, 0.15); //0.06 0.2 0.10 0.15
  ...
  if (cloud_cylinder->points.empty() || cloud_cylinder->points.size() < 10){ //40
